...
def draw(g_text, text, x, y, value, t, version):
    ...
    if version == 1:
        version_text = fontOBJ1.render(str(value) + " " + str(t), True, green)
...
while run:
    ...
    time_3 += 0.5
    if time >= 0 and load is True or ext_ro is True:
        pygame.draw.rect(screen, (255, 255, 255), (10, 470, 480, 20), 1)
        load_text = fontOBJ2.render("Load ", False, (255, 255, 255))
        screen.blit(load_text, (10, 435))
    if time_3 >= 1 and load is True:
        pygame.draw.rect(screen, (0, 255, 0), (11, 471, x, 18))
        x += 1
        time_3 = 0
